...
class Data:
    def __init__(self):
        ...
        self.read_train_images( './data/train-images.idx3-ubyte')
        self.read_train_labels( './data/train-labels.idx1-ubyte')

        self.train_data = np.append( self.train_img_list, self.train_label_list, axis = 1 )


        self.read_test_images('./data/t10k-images.idx3-ubyte')
        self.read_test_labels('./data/t10k-labels.idx1-ubyte')
